					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="date" class="form-control border-input" id="txtDataVenc" value = "">
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="date" class="form-control border-input" disabled id="txtDataLancamento" value = "">
